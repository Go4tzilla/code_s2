...
<div class ="col-xs-6 msg" style="position:fixed;right:0;margin-top:5px;">
<div class="btn-group-vertical" style="top:90">
            <form role="form" action="" method="POST" name="edit" style="width:300px">
                <button class="btn btn-primary" style="background:#b92b27;height:32px;margin-bottom:9px"name="suppress" title="supprimer mon compte" value="convos"><span style="margin-bottom:5px">Supprimer mon compte</span></button>
            </form>
        </div>
</div>
</div>