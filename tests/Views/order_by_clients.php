...
<?php
    ...
    <table class="table-scroll table-striped"><thead><tr style="height:90px;min-height:90px">
    <th>
    ...
    style="z-index:3;width:20px;padding:2px;height:20px;position:absolute;bottom:-12px;right:2px;background:transparent;border:none" value="">
    ...
    style="z-index:3;width:20px;padding:2px;height:20px;position:absolute;bottom:-10px;right:2px;background:transparent;border:none" value="">
    <img src="./Views/icons/descending.png"/>
    </button>
    </div>
    </div>
    ...
    style="padding:2px;z-index:3;min-width:10px;min-height:10x;position:absolute;bottom:28px;right:-5px;background:transparent;border:none")"/>
    <img src="./Views/icons/ascending.png"/>
    </button>
    ...
    style="z-index:3;width:20px;padding:2px;height:20px;position:absolute;bottom:0px;right:2px;background:transparent;border:none" value="">
    <img src="./Views/icons/descending.png"/>
    </button>
    </div>
    </th>
    ...
    style="padding:2px;z-index:3;width:15px;height:15px;position:absolute;bottom:28px;right:-7px;background:transparent;border:none")"/>
    <img src="./Views/icons/ascending.png"/>
    </button>
    <button type="submit" name="breed_desc" value="desc-chip" 
    title="Trier par numéro de puce descendant" onclick="order_by(this.value)" 
    style="z-index:3;width:20px;padding:2px;height:20px;position:absolute;bottom:-12px;right:-12px;background:transparent;border:none" value="">
    <img src="./Views/icons/descending.png"/>
    </button>
    </div></th>
